            ...
            <div class="accordion" id="accordionExpediente">
                        ...
                        <div class="accordion-body">
                            ...
                            <table class="table table-hover text-center shadow-sm table-header-blue mb-4">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="text" name="lens_esfera_od" class="form-control input-modern">
                                        </td>
                                        <td><input type="text" name="lens_cil_od" class="form-control input-modern">
                                        </td>
                                        <td><input type="text" name="lens_eje_od" class="form-control input-modern">
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="lens_esfera_oi" class="form-control input-modern">
                                        </td>
                                        <td><input type="text" name="lens_cil_oi" class="form-control input-modern">
                                        </td>
                                        <td><input type="text" name="lens_eje_oi" class="form-control input-modern">
                                        </td>
                            ...
                            <table class="table table-hover text-center shadow-sm table-header-blue">
                                ...
                                <tbody>
                                    <tr>
                                        <th class="text-primary">OD</th>
                                        <td><input type="text" name="AV_VL_SC_OD" class="form-control input-modern">
                                        </td>
                                        <td><input type="text" name="PH_OD" class="form-control input-modern"></td>
                                        <td><input type="text" name="AV_VP_SC_OD" class="form-control input-modern">
                                        </td>
                                        <td><input type="text" name="DISTANCIA_OPTOTIPO_OD"
                                                class="form-control input-modern"></td>
                                    </tr>

                                    <tr>
                                        <th class="text-primary">OI</th>
                                        <td><input type="text" name="AV_VL_SC_OI" class="form-control input-modern">
                                        </td>
                                        <td><input type="text" name="PH_OI" class="form-control input-modern"></td>
                                        <td><input type="text" name="AV_VP_SC_OI" class="form-control input-modern">
                                        </td>
                                        <td><input type="text" name="DISTANCIA_OPTOTIPO_OI"
                                                class="form-control input-modern"></td>
                                    </tr>

                                    <tr>
                                        <th class="text-primary">AO</th>
                                        <td><input type="text" name="AV_VL_SC_AO" class="form-control input-modern">
                                        </td>
                                        <td><input type="text" name="PH_AO" class="form-control input-modern"></td>
                                        <td><input type="text" name="AV_VP_SC_AO" class="form-control input-modern">
                                        </td>
                                        <td><input type="text" name="DISTANCIA_OPTOTIPO_AO"
                                                class="form-control input-modern"></td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                <div class="accordion-item expediente-section-card mb-3">
                    ...
                    <div id="panelExterno" class="accordion-collapse collapse">
                        <div class="accordion-body">
                            <textarea name="orbitaCejas" class="form-control input-modern mb-2"
                                placeholder="Órbita / Cejas"></textarea>
                            <textarea name="parpadosPestanas" class="form-control input-modern mb-2"
                                placeholder="Párpados / Pestañas"></textarea>
                            <textarea name="sistemaLagrimal" class="form-control input-modern mb-2"
                            ...
                            <table class="table table-hover text-center shadow-sm table-header-blue mb-4">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="text" name="Cilindro_OD" class="form-control input-modern">
                                        </td>
                                        <td><input type="text" name="Eje_OD" class="form-control input-modern"></td>
                                        <td><input type="text" name="DP_OD"
                                                class="form-control input-modern campo-obligatorio campo-decimal"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="Cilindro_OI" class="form-control input-modern">
                                        </td>
                                        <td><input type="text" name="Eje_OI" class="form-control input-modern"></td>
                                        <td><input type="text" name="DP_OI"
