                                    ...
                                    <div class="register-container edit-product-card">
                                        ...
                                        <div class="p-4">
                                            ...
                                            <form method="POST" action="../Controller/productoController.php"
                                                name="editarProductoForm" id="formEditarProducto"
                                                ...
                                                <div class="col-12 col-lg-10">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input type="text" id="ProductoId" name="ProductoId"
                                                                class="form-control"
                                                                value="<?php echo htmlspecialchars($producto['ProductoId']); ?>"
                                                                readonly>
                                                        </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="Descripcion" id="Descripcion"
                                                            class="form-control auto-grow" rows="2"
                                                    ...
                                                    <div class="mt-3">
                                                        ...
                                                        <div class="mb-4">
                                                            <label class="form-label d-block text-center">Cambiar
                                                                imagen</label>

                                                            <div class="upload-modern-box upload-wide"
                                                                id="uploadBoxEditar">
                                                                <div class="upload-modern-icon">
                                                                    <i class="bi bi-cloud-arrow-up"></i>
                                                                </div>

                                                                <p class="upload-modern-text mb-3">Arrastra tu imagen o
                                                                    selecciónala</p>
                                                                ...
                                                                <p id="nombreArchivoImagenEditar"
                                                                    class="upload-file-name mt-3 mb-0">
                                                                    Ningún archivo seleccionado
                                                                </p>
                                                            </div>

                                                            <small class="text-muted d-block mt-2 text-center">
                                                                Si no selecciona una nueva imagen, se conservará la
                                                                actual.
                                                            </small>
                                                        </div>
