...
<body>
    ...
    <main class="form-section register-pos-page">
        <div class="container">

            <div class="d-flex justify-content-end register-pos-back">
            ...
            <div class="register-card-compact shadow-lg mx-auto" style="animation: fadeUp .5s ease;">
                    ...
                    <form method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="Cedula" name="Cedula"
                                value="<?= htmlspecialchars($cedulaPrefill) ?>" placeholder="Cédula" required readonly>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="Apellido" name="Apellido"
                                    placeholder="Primer Apellido" readonly required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="ApellidoDos" name="ApellidoDos"
                                    placeholder="Segundo Apellido" readonly required>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="password" class="form-control" name="Contrasenna" placeholder="Contraseña"
                                    required>
                            </div>
