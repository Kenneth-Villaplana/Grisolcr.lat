...
$totalPersonal = count($listaPersonal);
$totalPaginas = ceil($totalPersonal / $personalPorPagina);

$inicio = ($paginaActual - 1) * $personalPorPagina;
$personalPaginado = array_slice($listaPersonal, $inicio, $personalPorPagina);
                ...
                <div class="inventario-filters shadow-sm rounded-4 mb-5">
                    ...
                    <form method="GET" class="row g-3 align-items-end">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="cedula" class="form-control inventario-input"
                    ...
                    <div class="staff-card-inner">
                        ...
                        <div class="table-responsive staff-table-responsive">
                            <table class="table staff-table align-middle mb-0">
                                ...
                                <tbody>
                                    <?php foreach ($personalPaginado as $personal): ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span
                                                    class="staff-status-pill <?php echo $esActivo ? 'status-activo' : 'status-inactivo'; ?>">
                                ...
                                <nav>
                                    <ul class="pagination mb-0">
                                        ...
                                        <li class="page-item <?= $paginaActual <= 1 ? 'disabled' : '' ?>">
                                            <a class="page-link"
                                                href="?pagina=<?= $paginaActual - 1 ?>&cedula=<?= urlencode($cedulaFiltro ?? '') ?>">
                                                ‹ Anterior
                                            </a>
                                        </li>
                                        ...
                                        if ($inicioPag > 1) {
                                            echo '<li class="page-item"><a class="page-link" href="?pagina=1&cedula=' . urlencode($cedulaFiltro ?? '') . '">1</a></li>';
                                        ...
                                        for ($i = $inicioPag; $i <= $finPag; $i++): ?>
                                            <li class="page-item <?= $i == $paginaActual ? 'active' : '' ?>">
                                                <a class="page-link"
                                                    href="?pagina=<?= $i ?>&cedula=<?= urlencode($cedulaFiltro ?? '') ?>">
                                                    <?= $i ?>
                                                </a>
                                            </li>
                                        <?php endfor;
                                        ...
                                        if ($finPag < $totalPaginas) {
                                            ...
                                            echo '<li class="page-item"><a class="page-link" href="?pagina=' . $totalPaginas . '&cedula=' . urlencode($cedulaFiltro ?? '') . '">' . $totalPaginas . '</a></li>';
                                        }
                                        ?>
