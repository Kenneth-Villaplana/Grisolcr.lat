...
<body>
    ...
    <main class="container py-5 pv-wrapper ">
        ...
        <div class="mb-4 pv-header pv-header-center">
            <div>
                ...
                <div class="card shadow-sm pv-cart-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3" id="telefonoClienteDiv" style="display:none;">
                            ...
                            <small id="telefonoError" class="text-danger d-none">El número debe tener al menos 8
                                dígitos.</small>
                        </div>
                        ...
                        <div id="datosEmpresa" style="display:none;">
                            ...
                            <input id="empresaIdentificacion" class="form-control"
                                placeholder="Identificación jurídica">
                        </div>
