...
<div style='font-family: Arial, sans-serif; background-color: #f5f5f5; padding: 20px;'>
  <div style='max-width: 600px; margin: auto; background: white; border-radius: 10px; padding: 25px; border: 1px solid #ddd;'>
    <h2 style='text-align:center; color:#0D3B66; margin-bottom: 10px;'>Recuperación de Contraseña</h2>
    <p style='font-size: 15px; color: #333;'>Hola <strong>{$nombre} {$apellido}</strong>,</p>
    <p style='font-size: 15px; color: #333;'>
      Hemos recibido una solicitud para restablecer la contraseña de su cuenta en <strong>Óptica Grisol</strong>.
      Si usted realizó esta solicitud, por favor haga clic en el siguiente botón:
    </p>
    ...
    <p style='font-size: 14px; color: #555;'>Si el botón no funciona, copie y pegue este enlace en su navegador:</p>
    <p style='word-break: break-all; font-size: 13px; color: #0D3B66;'>{$enlace}</p>
